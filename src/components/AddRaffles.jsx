...
const AddRaffleCard = ({ onBack = () => { } }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await addRaffleCard(formDataToSend);
            ...
            setError(err.message || 'Failed to add raffle card');
        } finally {
            setLoading(false);
        }
    };
    ...
    const addRaffleCard = async (formDataFromComponent) => {
        try {
            ...
            // IMPORTANT: Use "thumbnail" instead of "image"
    ...
    return (
        <div className="min-h-screen text-white">
            ...
            <div className="bg-[#282727] rounded-lg p-8 ">
                <h1 className="text-2xl font-bold mb-8">Add New Card</h1>
            ...
            `}</style>
                ...
                <div className="flex gap-4">
                    ...
                    <button
                        ...
                        disabled={loading}
                    >
                        {loading ? 'Adding Card...' : 'Confirm Add'}
                    </button>
                </div>
            </div>
        </div>
